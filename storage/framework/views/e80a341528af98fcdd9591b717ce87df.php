            ...
            <div class="p-4">
                ...
                <div class="mb-6">
                    <div class="flex items-center mb-2">
                        <input type="checkbox" id="<?php echo e($i); ?>Management" class="mr-2">
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Development\Maniruzzaman Akash\laradashboard\resources\views/backend/pages/roles/create.blade.php ENDPATH**/ ?>