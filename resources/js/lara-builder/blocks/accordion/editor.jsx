        ...
        <div>
            ...
            <div style={sectionStyle}>
                ...
                <div style={{ marginTop: '12px' }}>
                    <label style={labelStyle}>Transition Duration (ms)</label>
                    <input
                        type="number"
            ...
            {/* Header Section */}
            <div style={sectionStyle}>
                <div style={sectionTitleStyle}>Header Styling</div>
                ...
                <label style={labelStyle}>Active Background Color</label>
                <div style={colorInputContainerStyle}>
                    <input
                        type="color"
            ...
            {/* Title Section */}
            <div style={sectionStyle}>
                <div style={sectionTitleStyle}>Title Styling</div>
            ...
            {/* Content Section */}
            <div style={sectionStyle}>
                <div style={sectionTitleStyle}>Content Styling</div>
            ...
            <div style={{
                ...
                <strong style={{ color: '#374151' }}>Tip:</strong> Double-click on titles or content in the canvas to edit them directly. Use the "Add Accordion Item" button to add more items.
            </div>
        </div>
    );
};
