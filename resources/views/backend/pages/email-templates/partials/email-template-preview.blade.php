<div class="relative group">
    ...
    >
        @if($emailTemplate->body_html)
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                <div class="origin-top-left" style="transform: scale(0.2); width: 1250%; height: 1250%;">
    ...
    <div class="absolute left-0 top-full mt-2 hidden group-hover:block z-50 pointer-events-none">
        <div class="bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg shadow-2xl overflow-hidden" style="width: 300px; height: 400px;">
            @if($emailTemplate->body_html)
