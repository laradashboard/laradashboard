...
use Modules\Squartup\Services\ModuleService;
use Nwidart\Modules\Traits\PathNamespace;
use RecursiveDirectoryIterator;
use RecursiveIteratorIterator;

class SquartupServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Squartup';

    protected string $nameLower = 'squartup';
